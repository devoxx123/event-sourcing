...
import com.shopping.web.cart.*;
import com.shopping.web.catalog.Catalog;
import com.shopping.web.inventory.Inventory;
import com.shopping.web.order.Order;
import com.shopping.web.order.OrderEvent;
import com.shopping.web.order.OrderEventType;
 ...
 * {@link com.shopping.web.cart.LineItem}.
 *
 * @author Ben Hale
                ...
                if (checkAvailableInventory(checkoutResult, currentCart, inventoryItems)) {
                    ...
                    Order orderResponse = oAuth2RestTemplate.postForObject("http://order-service/v1/orders",
                            currentCart.getLineItems().stream()
                                    .map(prd ->
                                            new com.shopping.web.order.LineItem(prd.getProduct().getName(),
